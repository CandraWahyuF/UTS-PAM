...
const Detail = ({ navigation, route }) => {
    ...
    const scheduleList = JADWAL.filter(item =>
        item.dermaga_keberangkatan === data.keberangkatan &&
        item.dermaga_tujuan === data.datang &&
        item.kelas_layanan === data.layan &&
        item.tanggal_masuk === data.waktu &&
        item.jam_masuk === data.waktu);
                        ...
                        renderItem={({ item }) => (
                            <View style={styles.card}>
                                <TouchableOpacity style={styles.detail_search}>
                                    ...
                                    <Text style={styles.detailInfowaktu}>
                                        {item.jam_masuk}
                                    </Text>
